...
<head>
    ...
    ?>
                            <?php foreach($elements as $element): ?>
                                ...
                                <img src="<?php echo $element['personImg'] ?>" alt="<?php echo $element['altName'] ?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                    <?php echo $element['name'] ?>
                                        <small class="m-0 fw-300">
                                        <?php echo $element['posision'] ?>
                                        </small>
                                    </h5>


                                    <a href="<?php echo $element['twitterLink'] ?>" class="text-info fs-sm" target="_blank"><?php echo $element['twitterAcc'] ?></a> 

                                    -
                                    <a href="<?php echo $element['wrapLink'] ?>" class="text-info fs-sm" target="_blank" title="<?php echo $element['linkToContact'] ?>"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
