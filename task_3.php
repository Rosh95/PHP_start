...
?>
                        <div class="panel-content">
                            ...
                            <?php foreach($items as $item): ?> 
                                <div class="d-flex">
                             <?php echo $item['title'] ?>
                                <span class="d-inline-block ml-auto">  <?php echo $item['size'] ?></span>
                            </div>
                            <div class="progress progress-sm mb-3">
                                <div class="progress-bar   <?php echo $item['color'] ?>" role="progressbar" style="width:<?php echo $item['width'] ?>;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <?php endforeach ?>
