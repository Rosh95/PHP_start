...
<head>
    ...
    [
        ...
        'imageLink' => 'img/demo/gallery/21.jpg'
    ],
    [
        'image' => 'img/demo/gallery/thumb/22.jpg',
        'imageLink' => 'img/demo/gallery/22.jpg'
    ],
    [
        'image' => 'img/demo/gallery/thumb/23.jpg',
        'imageLink' => 'img/demo/gallery/23.jpg'
    ],
    [
        'image' => 'img/demo/gallery/thumb/24.jpg',
        'imageLink' => 'img/demo/gallery/24.jpg'
    ],
    [
        'image' => 'img/demo/gallery/thumb/25.jpg',
        'imageLink' => 'img/demo/gallery/26.jpg'
    ],
    [
    ...
    ?>
                                <?php foreach($pictures as $picture):?>
                                    <a class="" href="<?php echo $picture['imageLink'] ?>">
                                    <img class="img-responsive" src="<?php echo $picture['image'] ?>" alt="image">
                                </a>
                                <?php endforeach ?> 
                            </div>
                        </div>
