...
<head>
    ...
    ?>
                            <?php foreach($people as $person): ?>
                                ...
                                <img src="<?php echo $person['personImg'] ?>" alt="<?php echo $person['altName'] ?>" class="img-thumbnail img-responsive rounded-circle" style="width:5rem; height: 5rem;">
                                <div class="ml-2 mr-3">
                                    <h5 class="m-0">
                                    ...
                                    <a href="<?php echo $person['twitterLink'] ?>" class="text-info fs-sm" target="_blank"><?php echo $person['twitterAcc'] ?></a> 

                                    -
                                    <a href="<?php echo $person['wrapLink'] ?>" class="text-info fs-sm" target="_blank" title="<?php echo $person['linkToContact'] ?>"><i class="fal fa-envelope"></i></a>
                                </div>
                            </div>
